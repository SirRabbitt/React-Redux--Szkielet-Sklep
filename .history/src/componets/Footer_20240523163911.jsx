  ...
  return (
    <div className='bg-black text-gray-400 py-20 '>
     <div className='max-w-screen-xl mx-auto' >
        ...
        <div className='h-40 w-40 d-flex align-items-center justify-content-center flex gap-3 mt-4 ' >  
        <div className=  '  h-100 w-100 hover:text-white duration-100 cursor-pointer' >< className FaGithub /></div>
